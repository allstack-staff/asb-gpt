...
exports.GPT = void 0;
const asb_openai_1 = __importStar(require("../asb-openai"));
class GPT extends asb_openai_1.default {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const messages = this.history
                    ? this.messages
                    : [this.defaultContentMessage];
                const res = yield this.chatRequest("POST", asb_openai_1.CHAT_URL, {
                    model: this.model,
                    messages: messages,
    ...
    requestChat(config) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.chatRequest("POST", asb_openai_1.CHAT_URL, mergedConfig);
                return response;
            }
            catch (err) {
