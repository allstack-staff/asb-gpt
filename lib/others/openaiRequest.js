        ...
        return __awaiter(this, void 0, void 0, function* () {
            (0, axios_1.default)({
                ...
                writeStream.on('error', (error) => {
                    throw new asb_openai_1.WriteStreamError(`Erro ao criar arquivo com a imagem:\n\n${__filename}\n\n${error}`);
                });
            })
                .catch((error) => {
                throw new asb_openai_1.WriteStreamError(`Erro ao baixar a imagem:\n\n${__filename}\n\n${error}`);
            });
        });
    }
